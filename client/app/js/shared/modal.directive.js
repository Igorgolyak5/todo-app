/**
 * Directive needed for modal window.
 */
angular.module('taskApp').directive('modal', function(){
        return {
            ...
            '<div class="modal-content" ng-transclude><div class="modal-header">' +
 ...
 */
angular.module('taskApp').directive('modalHeader', function(){
    return {
 ...
 */
angular.module('taskApp').directive('modalBody', function(){
    return {
 ...
 */
angular.module('taskApp').directive('modalFooter', function(){
    return {
